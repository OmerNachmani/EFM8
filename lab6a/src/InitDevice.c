...
PORTS_2_enter_DefaultMode_from_RESET (void)
{
  ...
  P2MDOUT = P2MDOUT_B0__OPEN_DRAIN | P2MDOUT_B1__OPEN_DRAIN
      ...
      | P2MDOUT_B5__OPEN_DRAIN | P2MDOUT_B6__PUSH_PULL | P2MDOUT_B7__OPEN_DRAIN;
  // [P2MDOUT - Port 2 Output Mode]$
  ...
  P2SKIP = P2SKIP_B0__NOT_SKIPPED | P2SKIP_B1__NOT_SKIPPED
      ...
      | P2SKIP_B5__SKIPPED | P2SKIP_B6__SKIPPED | P2SKIP_B7__NOT_SKIPPED;
  // [P2SKIP - Port 2 Skip]$
...
TIMER_SETUP_0_enter_DefaultMode_from_RESET (void)
{
   ...
   ***********************************************************************/
  TMOD = TMOD_T0M__MODE1 | TMOD_T1M__MODE0 | TMOD_CT0__COUNTER
...
extern void
PORTS_4_enter_DefaultMode_from_RESET (void)
{
  // $[P4 - Port 4 Pin Latch]
  // [P4 - Port 4 Pin Latch]$
  ...
  /***********************************************************************
   - P4.0 pin is configured for digital mode
   - P4.1 pin is configured for digital mode
   - P4.2 pin is configured for digital mode
   - P4.3 pin is configured for digital mode
   - P4.4 pin is configured for analog mode
   - P4.5 pin is configured for digital mode
   - P4.6 pin is configured for digital mode
   - P4.7 pin is configured for digital mode
   ***********************************************************************/
  P4MDIN = P4MDIN_B0__DIGITAL | P4MDIN_B1__DIGITAL | P4MDIN_B2__DIGITAL
      | P4MDIN_B3__DIGITAL | P4MDIN_B4__ANALOG | P4MDIN_B5__DIGITAL
